...
const icons = ({
    ...
    svg: (
      ...
      >
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M11.3132 20.3163L21.4951 9.81629L20.7989 9.09839L11.3132 18.8806L7.48399 14.9317L6.78784 15.6496L11.3131 20.3163L11.3132 20.3162L11.3132 20.3163Z"
          fill={colorSecondary}
          opacity={opacitySecondary}
        />
      </svg>
    ...
    svg: (
      ...
      >
        <g>
          <path
            data-name="Path"
            d="M47.719,39.04c.007-.017.081-.232,0,0Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M18.373,31.621c3.714,2.318,8.581,2.7,12.843,2.355,4.311-.351,9.092-1.53,12.44-4.422a8.923,8.923,0,0,0,3.183-5.507c.084-.643.236-1.516-.521-1.809-1.238-.478-1.2,1.233-1.326,1.911-3.461-3.878-11.031-4.342-15.833-4-4.356.312-10.468,1.836-12.757,6.017-.06-.63-.084-1.607-1-1.546-1.136.075-.844,1.54-.682,2.252A7.733,7.733,0,0,0,18.373,31.621Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M46.571,31.36a.9.9,0,1,0,.944.849A.907.907,0,0,0,46.571,31.36Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M45.082,38.7a.9.9,0,1,0,.944.849A.907.907,0,0,0,45.082,38.7Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M42.42,35.546a.9.9,0,1,0,.944.848A.907.907,0,0,0,42.42,35.546Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Compound Path"
            d="M62.355,40.243a14,14,0,0,0-2.9-6.02A21.842,21.842,0,0,0,57.959,32.6c-.027-.293-.068-.587-.122-.88a9.064,9.064,0,0,0-.465-1.673,6.738,6.738,0,0,0-1-1.761A4.856,4.856,0,0,0,51.5,26.625h0A10.857,10.857,0,0,0,47.678,19.1c-2.8-2.266-6.8-3.075-10.281-3.519a39.8,39.8,0,0,0-11.941.226c-4.1.732-8.39,2.206-11.345,5.282a11.773,11.773,0,0,0-1.6,2.1A7.979,7.979,0,0,0,11.069,27.9c.025.46.06,1.193.1,1.937-3.6,2.413-7.163,5.324-9.025,9.29-2.1,4.484-.239,9.126,2.389,12.976,6.028,8.826,16.881,10.471,26.983,10.717,9.973.246,20.233-1.632,26.963-9.516C61.57,49.691,63.331,44.96,62.355,40.243ZM51.6,28.126a8.291,8.291,0,0,1,2.61.342,2.811,2.811,0,0,1,.328.144,2.629,2.629,0,0,1,.88.7,3.6,3.6,0,0,1,.71,1.29,5.567,5.567,0,0,1,.184.669,4.964,4.964,0,0,1,.1.621,9.269,9.269,0,0,1,.034,1.98.087.087,0,0,1-.007.041A9.408,9.408,0,0,1,53.4,40.373a4.8,4.8,0,0,1-3.352,1.085c-.328-.021-.763-.169-1.183-.245.259-.653.495-1.313.711-1.975a5.706,5.706,0,0,0,1.551-.432A5.9,5.9,0,0,0,54.2,34.853c.337-1.461-.076-4.757-2.577-4.231-.032,0-.068.014-.1.023A21.468,21.468,0,0,0,51.6,28.126ZM50.235,37.1A36.48,36.48,0,0,0,51.3,32.473c.216-.14.421-.274.655-.192,1.155.406.661,3.065.209,3.706a3.954,3.954,0,0,1-1.56,1.227,2.144,2.144,0,0,1-.442.126C50.186,37.259,50.211,37.176,50.235,37.1ZM12.826,27.407a7.9,7.9,0,0,1,2.8-5.3,15.933,15.933,0,0,1,5.641-3.355,33.69,33.69,0,0,1,13.978-1.6c.145.015.824.075.964.09.79.083,1.578.186,2.361.32a28.527,28.527,0,0,1,3.965.951c2.425.781,4.664,1.994,5.956,4.275,2.619,4.626.742,11.412-.735,16.137a18.661,18.661,0,0,1-4.5,7.193,18.684,18.684,0,0,1-8.574,4.411,28.209,28.209,0,0,1-6.453.194c-6.3-1.029-9.63-4.018-12.561-9.444A29.627,29.627,0,0,1,12.826,27.407ZM52.785,56.08a39.766,39.766,0,0,1-6.02,3.16,1.7,1.7,0,0,0-.212.075C41.8,61.24,35.42,61.261,30.062,61.042c-5.891-.225-12.069-.846-17.3-3.727-4.628-2.553-8.874-7.467-9.7-12.751-.437-2.8.7-5.3,2.423-7.488a32.012,32.012,0,0,1,5.679-5.14l.134-.094c.011.119.021.232.032.319A28.383,28.383,0,0,0,14.317,42.54c3.158,5.759,7.048,8.541,13.152,9.939,3.738.857,8.652-.328,10.653-.964a19.362,19.362,0,0,0,8.156-5.781,13.5,13.5,0,0,0,1.88-2.907,9.344,9.344,0,0,0,4.716-.188A8.813,8.813,0,0,0,57.4,37.486a9.73,9.73,0,0,0,.546-2.335,12.067,12.067,0,0,1,2.914,7.283C61.1,48.107,57.27,52.912,52.785,56.08Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
          ...
          <path
            data-name="Path"
            d="M29.765,7.756a3.757,3.757,0,0,1,.534,3.052c-.059.444-1.622,2.411,0,2.68.752.125,1.366-1.829,1.5-2.31a5.455,5.455,0,0,0,.187-2.035C31.809,7.8,30.9,7.009,30.161,5.924a2.154,2.154,0,0,1,.161-3.007c.526-.514,2-.4,2.167-1.075a.615.615,0,0,0-.106-.513.717.717,0,0,0-.464-.284,4.115,4.115,0,0,0-.628-.027l-.029,0a2.923,2.923,0,0,0-.672.134,3.5,3.5,0,0,0-1.123.633,3.587,3.587,0,0,0-1.359,3.087C28.232,6.031,29.12,6.81,29.765,7.756Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M39.209,11.615a2.348,2.348,0,0,1-.225,1.581c-1.365,1.767.455,1.894.995,1.113a3.273,3.273,0,0,0,.134-4.038c-.439-.741-1.1-2.243-.208-2.905.447-.331,1.292-.1,1.593-.621a.693.693,0,0,0-.7-.975c-2.152.214-3.06,1.509-2.624,3.382A22.38,22.38,0,0,0,39.209,11.615Z"
            fill={colorMain}
            opacity={opacityMain}
          />
          <path
            data-name="Path"
            d="M22.017,11.675a2.341,2.341,0,0,1,.01,1.594c-1.093,1.913.73,1.824,1.15.985a3.272,3.272,0,0,0-.462-4.018c-.545-.683-1.424-2.093-.635-2.855.4-.381,1.267-.251,1.488-.8a.712.712,0,0,0-.842-.883c-2.1.466-2.811,1.858-2.1,3.663A23.221,23.221,0,0,0,22.017,11.675Z"
            fill={colorMain}
            opacity={opacityMain}
          />
        </g>
  ...
  },
  {
    ...
    svg: (
      ...
      >
        <path
          d="M16 1V3H8V1H6V3H5C3.89 3 3.01 3.9 3.01 5L3 19C3 20.1 3.89 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3H18V1H16ZM19 19H5V8H19V19Z"
          fill={colorMain}
          opacity={opacityMain}
        />
      </svg>
    ...
    svg: (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M11 19H17V13H11V19ZM13 15H15V17H13V15ZM19 5H18V3H16V5H8V3H6V5H5C3.895 5 3.01 5.896 3.01 7L3 21C3 22.105 3.895 23 5 23H19C20.104 23 21 22.105 21 21V7C21 5.896 20.104 5 19 5ZM5 10H19V21H5V10Z"
          fill={colorMain}
          opacity={opacityMain}
        />
      </svg>
  ...
  },
  {
    ...
    svg: (
      ...
      >
        <path
          d="M16.295 14.885C16.6844 15.2744 16.6844 15.9056 16.295 16.295C15.9056 16.6844 15.2744 16.6844 14.885 16.295L12 13.41L9.115 16.295C8.72564 16.6844 8.09436 16.6844 7.705 16.295C7.31564 15.9056 7.31564 15.2744 7.705 14.885L10.59 12L7.705 9.115C7.31564 8.72564 7.31564 8.09436 7.705 7.705C8.09436 7.31564 8.72564 7.31564 9.115 7.705L12 10.59L14.885 7.705C15.2744 7.31564 15.9056 7.31564 16.295 7.705C16.6844 8.09436 16.6844 8.72564 16.295 9.115L13.41 12L16.295 14.885Z"
          fill={colorSecondary}
          opacity={opacitySecondary}
        />
    ...
    svg: (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12 4C7.6 4 4 7.6 4 12C4 16.4 7.6 20 12 20C15.7 20 18.8 17.4 20 14H18C16.8 16.3 14.6 18 12 18C8.7 18 6 15.3 6 12C6 8.7 8.7 6 12 6C13.7 6 15.1 6.7 16 8L13 11H20V4L18 6C16.2 5 14.2 4 12 4Z"
          fill={colorMain}
          opacity={opacityMain}
        />
      </svg>
